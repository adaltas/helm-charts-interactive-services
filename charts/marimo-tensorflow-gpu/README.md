...
Marimo reactive Python notebook with Python and the deep-learning framework TensorFlow, with GPU support.
...
| service.image.custom.version | string | `"pacordonnier/marimo-tensorflow:py3.13.12-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"pacordonnier/marimo-tensorflow:py3.13.12-gpu"` |  |
