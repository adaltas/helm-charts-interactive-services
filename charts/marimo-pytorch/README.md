...
Marimo reactive Python notebook with Python and the deep-learning framework PyTorch.
...
| service.image.custom.version | string | `"pacordonnier/marimo-pytorch:py3.13.12"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"pacordonnier/marimo-pytorch:py3.13.12"` |  |
