...
Marimo reactive Python notebook with PySpark support.
...
| service.image.custom.version | string | `"pacordonnier/marimo-pyspark:py3.13.12-spark4.1.1"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"pacordonnier/marimo-pyspark:py3.13.12-spark4.1.1"` |  |
